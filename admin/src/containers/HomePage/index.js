        ...
        <div className="row">
          <div className="col-lg-8 col-md-12">
            <Block>
              ...
              >
                {(msg) => <h2 id="mainHeader">Bem vindo {username}</h2>}
              </FormattedMessage>
              {hasAlreadyCreatedContentTypes ? (
                <FormattedMessage id="app.components.HomePage.welcomeBlock.content.again">
                  {(msg) => (
                    <P>
                      Ao lado você pode incluir seus produtos, categorias e
                      publicações conforme a sua necessidade!
                    </P>
                  )}
                </FormattedMessage>
              ) : (
          ...
          <div className="col-md-12 col-lg-4">
            <Block style={{ paddingRight: 30, paddingBottom: 0 }}>
              <FormattedMessage id="HomePage.community">
                {(msg) => <h2>Acesse as nossas redes sociais!</h2>}
              </FormattedMessage>
              <FormattedMessage id="app.components.HomePage.community.content">
                {(content) => (
                  <P style={{ marginTop: 7, marginBottom: 0 }}>
                    Em casa de dúvidas e ou sugestôes, só ir em algum de nossos
                    redes!
                  </P>
                )}
              </FormattedMessage>
